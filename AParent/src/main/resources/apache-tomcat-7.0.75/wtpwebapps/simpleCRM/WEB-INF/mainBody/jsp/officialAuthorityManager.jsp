							...
							<div class="tabbable custom-tab tabs-left">
								...
								<ul class="nav nav-tabs tabs-left">
									<li class="active"><a href="#tab1" data-toggle="tab"
										onclick="getAllAuthorityManager('${pageContext.request.contextPath}/mainBodys/getAllAuthorityManager','6566dff0-0987-11e7-b918-28d2444b860a');">总经理</a></li>
								...
								<div class="tab-content"
									...
									<div class="tab-pane active" id="tab1" data-tab="6566dff0-0987-11e7-b918-28d2444b860a">
										<div class="clearfix">
											<div class="btn-group">
												<button onclick="saveAuthority(this,'${pageContext.request.contextPath}/mainBodys/updateUserroleAuthority')"
													data-userroleId="6566dff0-0987-11e7-b918-28d2444b860a"
													data-tabId="#tab1" class="btn green">
											...
											<tbody>
												<tr>
													<td><input type="checkbox" class="checkboxes"
														value="1" data-id="123" /></td>
													<td><a href="#">vector ltd</a></td>
													<td>lorem ipsum dorolo imit</td>
													<td>
														<button class="btn btn-success" onclick="pitchOn('123')">
															<i class="icon-ok"></i>
														</button>
														<button class="btn btn-danger" onclick="pitchOff('123')">
									...
									<div class="tab-pane" id="tab2" data-tab="5e8d627f-0987-11e7-b918-28d2444b860a">
										<div class="clearfix">
											<div class="btn-group">
												<button onclick="saveAuthority(this, '${pageContext.request.contextPath}/mainBodys/updateUserroleAuthority')"
									...
									<div class="tab-pane" id="tab3" data-tab="57695387-0987-11e7-b918-28d2444b860a">
										<div class="clearfix">
											<div class="btn-group">
												<button onclick="saveAuthority(this, '${pageContext.request.contextPath}/mainBodys/updateUserroleAuthority')"
