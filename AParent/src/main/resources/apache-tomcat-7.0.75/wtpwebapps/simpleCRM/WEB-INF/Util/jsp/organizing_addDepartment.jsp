...
<!-- 模态框 -->
<div class="modal fade" data-Modal="organizing_addDepartment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer" data-modalPart="modalFooter">
				<button type="button" class="btn btn-default" onclick='addDepartmentClick("${pageContext.request.contextPath}/mainBodys/insertDepartmentVo");'>保存</button>
